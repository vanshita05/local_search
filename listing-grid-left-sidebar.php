...
<!-- Mirrored from bizmap.dexignzone.com/xhtml/listing-grid-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2019 09:33:05 GMT -->
<head>
	<meta charset="utf-8">
                ...
                <div class="container clearfix">
                    ...
                    <div class="extra-nav">
                        <div class="extra-cell">
                            <a href="#" class="site-button-link white"><i class="ti-user m-r5 "></i>Sign In</a>
							<a href="#" class="site-button radius-xl m-l10">Add Listing</a>
                        </div>
                    </div>
                    <!-- main nav -->
        ...
        <div class="dlab-bnr-inr dlab-bnr-inr-sm overlay-black-middle" style="background-image:url(images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Grid Left Sidebar</h1>
						...
						<div class="col-lg-4 col-md-6">
							<div class="sticky-top">
								<div class="listing-filter-sidebar">
									<h4 class="title m-b30">Filter By</h4>
									<form>
										<div class="form-group">
											<div class="input-group">
												<input type="text" class="form-control" placeholder="What are your looking for?">
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
											...
											<div id="price-range">
												<div class="price-slide-2 range-slider m-t30">
													<div class="price">
														...
														<input type="text" id="distance" class="amount" readonly="" value="2km - 100km"/>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="listing-filter-sidebar">
									<h4 class="title">Filter By Tag</h4>
									<div class="widget_tag">
										<ul class="m-b0">
											<li><a href="javascript:void(0);">Travel</a> (28+)</li>
											<li><a href="javascript:void(0);">Foods</a> (39+) </li>
											<li><a href="javascript:void(0);">Rivery</a> (76+) </li>
											<li><a href="javascript:void(0);">Organic</a> (47+) </li>
											<li><a href="javascript:void(0);">Medicine</a> (36+) </li>
										</ul>
									</div>
								</div>
						...
						<div class="col-lg-8 col-md-6">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="listing-bx listing-half m-b30">
										<div class="listing-media">
											<img src="images/listing/pic14.jpg" alt="">
												<ul class="wish-bx">
										...
										<div class="listing-info">
											...
											<h3 class="title"><a href="listing-details.html">Rowdy King City</a></h3>
								...
								<div class="col-lg-12">
									<div class="listing-bx listing-half m-b30">
										<div class="listing-media">
											<img src="images/listing/pic15.jpg" alt="">
												<ul class="wish-bx">
												<li><a class="like-btn" href="javascript:void(0)"><i class="fa fa-heart"></i></a></li>
												<li><a class="info-btn" href="javascript:void(0)"><i class="fa fa-leaf"></i></a></li>
											</ul>
								...
								<div class="col-lg-12">
									<div class="listing-bx listing-half m-b30">
										<div class="listing-media">
											<img src="images/listing/pic13.jpg" alt="">
												<ul class="wish-bx">
												<li><a class="like-btn" href="javascript:void(0)"><i class="fa fa-heart"></i></a></li>
												<li><a class="info-btn" href="javascript:void(0)"><i class="fa fa-leaf"></i></a></li>
											</ul>
								...
								<div class="col-lg-12">
									<div class="listing-bx listing-half m-b30">
										<div class="listing-media">
											<img src="images/listing/pic16.jpg" alt="">
												<ul class="wish-bx">
												<li><a class="like-btn" href="javascript:void(0)"><i class="fa fa-heart"></i></a></li>
												<li><a class="info-btn" href="javascript:void(0)"><i class="fa fa-leaf"></i></a></li>
											</ul>
								...
								<div class="col-lg-12">
									<div class="listing-bx listing-half m-b30">
										<div class="listing-media">
											<img src="images/listing/pic17.jpg" alt="">
												<ul class="wish-bx">
												<li><a class="like-btn" href="javascript:void(0)"><i class="fa fa-heart"></i></a></li>
												<li><a class="info-btn" href="javascript:void(0)"><i class="fa fa-leaf"></i></a></li>
											</ul>
...
<!-- Mirrored from bizmap.dexignzone.com/xhtml/listing-grid-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2019 09:33:06 GMT -->
</html>