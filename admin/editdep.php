...
$qry="SELECT * FROM dep_tbl WHERE id=$id";
...
<input type="text" name="dep-name" class="form-control" value="<?php echo $row['depname']; ?>">
                                    <!-- <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Username"> -->
                                </div>
                                
   <input type="submit" name="btn_sb" class="btn-info" value="Update">
