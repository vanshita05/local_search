...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Local searech engine</title>
...
<div class="page-wraper">
                ...
                <div class="container clearfix">
                    ...
                    <div class="extra-nav">
                        <div class="extra-cell">
                            <a href="logout.php" class="site-button-link white"><i class="ti-user m-r5 "></i>Log out</a>
                        ...
                        <ul class="nav navbar-nav">              
							...
							<li class="down"><a href="#">Listings <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									...
									<li><a href="listing-details.html">Searvice </a></li>
								</ul>
							</li>
							<!-- <li class="down"><a href="#"> --> <!-- <i class="fa fa-chevron-down"></i></a> -->
								<!-- <ul class="sub-menu">
    ...
    <div class="page-content bg-white">
        <!-- Section Banner -->
		<div class="dlab-bnr-inr dlab-bnr-inr-md" style="background-image:url(images/main-slider/slide1.jpg); background-size: cover;">
            <div class="container">
                <div class="dlab-bnr-inr-entry align-m dlab-home">
					<div class="bnr-content">
						<h2><strong>LOCAL SEARCH ENGINE</strong> GOVREMENT OFFERS.</h2>
					</div>
		...
		<option value="<?php echo $row['id']; ?>" ><?php echo $row['depname']; ?></option><BR>
			...
			<button type="submit" class="site-button text-uppercase"  name="btn_sb" >Submit</button>
		...
		<div class="content-block">
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="featured-bx m-b30">
								...
								<div class="featured-info">
									...
									<h5 class="title"><a href="listing-details.html">Ahemedabad</a></h5>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="featured-bx m-b30">
								...
								<div class="featured-info">
									...
									<h5 class="title"><a href="listing-details.html">Gandhinagar</a></h5>
									<ul class="featured-category">
										<li><i class="fa fa-moon-o"></i> 12 Cities</li>
										<li><i class="fa fa-map-o"></i> 30+ Listing</li>
									</ul>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="featured-bx m-b30">
								...
								<div class="featured-info">
									...
									<h5 class="title"><a href="listing-details.html">Vadodra</a></h5>
									<ul class="featured-category">
										<li><i class="fa fa-moon-o"></i> 12 Cities</li>
										<li><i class="fa fa-map-o"></i> 30+ Listing</li>
									</ul>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="featured-bx m-b30">
								...
								<div class="featured-info">
									...
									<h5 class="title"><a href="listing-details.html">Surat</a></h5>
									<ul class="featured-category">
										<li><i class="fa fa-moon-o"></i> 12 Cities</li>
										<li><i class="fa fa-map-o"></i> 30+ Listing</li>
									</ul>
			...
			<div class="section-full bg-gray content-inner about-us">
                <div class="container-fluid">
					<div class="section-head text-black text-center">
						<h2 class="box-title">Top Trending News</h2>
						<div class="dlab-separator bg-primary"></div>
							...
							<div class="listing-bx m-b30">
								...
								<div class="listing-info">
									<ul class="featured-star">
										...
										<li><i class="fa fa-star"></i></li>
										<li><i class="fa fa-star"></i></li>
										<li class="rate"><span>5.0</span></li>
									</ul>
							...
							<div class="blog-post dez-blog">
								...
								<div class="dlab-info">
									...
									<div class="dlab-post-meta">
										<ul>
											<li class="post-author"><i class="fa fa-user-o"></i>By <a href="blog-details.html">John Doe</a> </li>
											<li class="post-comment"><i class="fa fa-comments-o"></i> <a href="blog-details.html">12 Comments</a> </li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="blog-post dez-blog">
								...
								<div class="dlab-info">
									...
									<div class="dlab-post-meta">
										<ul>
											<li class="post-author"><i class="fa fa-user-o"></i>By <a href="blog-details.html">Rosalina</a> </li>
											<li class="post-comment"><i class="fa fa-comments-o"></i> <a href="blog-details.html">08 Comments</a> </li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="blog-post dez-blog">
								...
								<div class="dlab-info">
									...
									<div class="dlab-post-meta">
										<ul>
											<li class="post-author"><i class="fa fa-user-o"></i>By <a href="blog-details.html">John Smith</a> </li>
											<li class="post-comment"><i class="fa fa-comments-o"></i> <a href="blog-details.html">03 Comments</a> </li>
										</ul>
									</div>
								</div>
							</div>
...
<!-- Mirrored from bizmap.dexignzone.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2019 09:32:54 GMT -->
</html>
