        ...
        <div class="dlab-bnr-inr dlab-bnr-inr-sm overlay-black-middle" style="background-image:url(images/banner/bnr5.jpg); height: 600px">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    ...
                    <h2 class="text-white">Your New paasword</h2>
                            ...
                            <div class="col-lg-12">
	                         	<!-- <div class="form-group">
					                <div class="input-group"> 
                                        <input type="text" name="password" class="form-control" required  placeholder="Enter Your Answer"><br>
                                    </div>
					            </div> -->
                                <div class="form-group">
                                    <div class="input-group"> 
                                        <input type="text" name="pwd" class="form-control" required  placeholder="Enter Your New Password"><br>
                                    </div>
                                </div>
                            </div>
