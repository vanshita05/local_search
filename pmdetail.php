...
$id=$_GET['id'];
$qry = "SELECT  * FROM pm_tbl WHERE isactive=1 and id='".$id."'";
// echo $qry;
                ...
                <div class="dlab-bnr-inr-entry">
					...
					<div class="wonder-theme"></div>
						<div class="wonder-title">
							<h2><?php echo$row['pmyojnaname'];?></h2>
							 <!-- <p><?php echo$row['pmyojnaname'];?></p>	 -->
						</div>
						<div class="wonder-price">
							<p>Date</p>
							<h3 class="m-b0"><?php echo"".date("d-m-y ")?></h3>
						</div>
			...
			<div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12 p-b30">
                        <div class="section-head text-black mb-3">
							...
							<h2 class="box-title"><?php echo$row['pmyojnaname'];?></h2>
							
						</div>
						<div class="clearfix m-b50">
							<img class="alignleft" src="./upload/<?php echo $row['profilepic']; ?>" width="300px" alt="">
						<p class="font-weight-300"><?php echo $row['pmyojnadecp'];?></p>
			<a href="<?php echo $row['pmyojnalink']; ?>"><?php echo $row['pmyojnalink']; ?></a>
							<!-- <p class="font-weight-30"><?php echo $row['pmyojnalink'];?></p> -->
						</div>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="comment-respond" id="respond">
                                        <form class="comment-form" method="post" action="reviewprocess.php" enctype="multipart/form-data">
                                            ...
                                            <p class="comment-form-profilepic">
                                                
                                                 <label class="text-white"> Upload Profile Pic <span class="required">*</span></label>
