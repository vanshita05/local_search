            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <div class="wonder-bx text-white">
						<div class="wonder-theme"><?php echo$row['newsname'];?></div>
						<div class="wonder-title">
							<h2><?php echo$row['newsname'];?></h2>
				...
				<div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12 p-b30">
                        <div class="section-head text-black mb-3">
							...
							<h2 class="box-title"><?php echo$row['newsname'];?></h2>
							
						</div>
						<div class="clearfix m-b50">
							<img class="alignleft" src="./upload/<?php echo $row['profilepic']; ?>" alt="">
							<p class="font-weight-300"><?php echo $row['newsdes'];?></p>
						</div>
                                    ...
                                    <ol class="comment-list">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img  class="avatar photo" src="images/testimonials/pic1.jpg" alt=""> <cite class="fn">Rosalina Kelian</cite> <span class="says">says:</span> </div>
                                                <div class="comment-meta"> 
													<a href="javascript:void(0);">19th May 2018</a> 
										...
										<li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img  class="avatar photo" src="images/testimonials/pic2.jpg" alt=""> <cite class="fn">Arista Williamson</cite> <span class="says">says:</span> </div>
                                                <div class="comment-meta">
													<a href="javascript:void(0);">19th May 2018</a> 
													<ul class="featured-star">
														<li><i class="fa fa-star"></i></li>
                                    ...
                                    <div class="comment-respond" id="respond">
                                        <form class="comment-form" id="commentform" method="post" action="#">
                                            ...
                                            <p class="comment-form-author">
                                                ...
                                                <input type="text" value="" name="Author"  placeholder="Type your name...." id="author">
                                            </p>
                                            <p class="comment-form-email">
                                                <label for="email">Type your email.... <span class="required">*</span></label>
                                                <input type="text" value="" placeholder="Type your email...." name="email" id="email">
                                            </p>
                                            <p class="comment-form-url">
                                                <label for="url">Type your website....</label>
                                                <input type="text"  value=""  placeholder="Type your website...."  name="url" id="url">
                                            </p>
                                            <p class="form-submit">
